...
class TableRestControllerTest extends ControllerTest {
    ...
    void create() throws Exception {
        final OrderTable 손님있는테이블 = createTable(null, 1111, false);
    ...
    void list() throws Exception {
        orderTableRepository.save(new OrderTable2(3333, false));
    ...
    void changeEmpty() throws Exception {
        final OrderTable2 비어있지않는테이블 = orderTableRepository.save(new OrderTable2(0, false));
    ...
    void changeNumberOfGuests() throws Exception {
        final OrderTable2 비어있지않는테이블 = orderTableRepository.save(new OrderTable2(4444, false));
