...
class OrderRestControllerTest extends ControllerTest {
    ...
    void list() throws Exception {
        ...
        Order2 생성하려는주문 = orderRepository.save(Order2.ofCooking(점유중인테이블));
        OrderLineItem2 주문항목 = orderLineItemRepository.save(new OrderLineItem2(생성하려는주문, 후라이드한마리세트, 1));
    ...
    void changeOrderStatus() throws Exception {
        OrderTable2 점유중인테이블 = orderTableRepository.save(new OrderTable2(5, false));
        Order2 완료되지않은주문 = orderRepository.save(Order2.ofCooking(점유중인테이블));
