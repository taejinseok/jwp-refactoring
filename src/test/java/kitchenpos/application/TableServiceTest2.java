...
class TableServiceTest2 {
    ...
    void create(boolean isEmpty, int numberOfGuests) {
        OrderTableCreateResponse 새테이블 = tableService.create(new OrderTableCreateRequest(numberOfGuests, isEmpty));
    ...
    void list() {
        ...
        final List<OrderTableResponse> 전체테이블목록 = tableService.list();
    ...
    //
    //     OrderTable2 updatedOrderTable = tableService.changeEmpty(테이블식별자, 빈테이블);
    //
    //     assertAll(
