...
class MenuServiceTest {
    ...
    @Test
    void list() {
        MenuGroup 세트그룹 = menuGroupRepository.save(new MenuGroup("세트 그룹"));
        Product 후라이드_2만원 = productRepository.save(new Product("후라이드 치킨", BigDecimal.valueOf(20_000)));
    ...
    void create_fail_if_total_menu_product_price_is_bigger_than_menu_price() {
        MenuGroup 세트그룹 = menuGroupRepository.save(new MenuGroup("세트 그룹"));
        Product 후라이드_1만원 = productRepository.save(new Product("후라이드 치킨", BigDecimal.valueOf(10_000)));
